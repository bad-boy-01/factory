...
class StoryboardPlanner:
    ...
    def plan_panels(self, text_chunk: str, current_state: dict, chapter: int = 1, start_sequence: int = 1) -> dict:
        ...
        system = (
            ...
            "STATE OVERRIDE: If the text introduces a completely new scene and characters, OVERRIDE the Provided State entirely. Do NOT carry over old locations or characters (like 'Arthur') if they are not in the current text.\n\n"
            ...
            "BEAT TYPES MUST BE USED CORRECTLY:\n"
            "- environment = location establishment (normally ONCE per location)\n"
            "- reveal = important new visual information\n"
            "- action = physical movement\n"
            "- reaction = visible response\n"
            "- emotion = internal/emotional state\n"
            "- dialogue = spoken interaction\n"
            "- transition = passage of time\n"
            "- object_focus = important inanimate object\n\n"
